<?php
namespace MyNewsExtension\DeNews\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class MyNewsExtension\DeNews\Controller\ArticleController.
 *
 * @author Dirk <post@de-velopment.de>
 */
class ArticleControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \MyNewsExtension\DeNews\Controller\ArticleController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('MyNewsExtension\\DeNews\\Controller\\ArticleController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllArticlesFromRepositoryAndAssignsThemToView() {
		...
		$articleRepository = $this->getMock('MyNewsExtension\\DeNews\\Domain\\Repository\\ArticleRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenArticleToView() {
		$article = new \MyNewsExtension\DeNews\Domain\Model\Article();
